...
#OUTCOME HARD w/ STANDARD SCALER ONLY# 
...
#					warm_start = True,
	...
	preds_binary = preds_binary.rename(columns={0: "normal", 1: "hard"})
	...
	preds_merged = preds_merged.rename(columns={0: "normal_prob", 1: "hard_prob"})
