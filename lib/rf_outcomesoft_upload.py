...
#OUTCOME SOFT w/ STANDARD SCALER ONLY# 
...
def main():
	...
	preds_binary = preds_binary.rename(columns={0: "normal", 1: "soft"})
	...
	preds_merged = preds_merged.rename(columns={0: "normal_prob", 1: "soft_prob"})
